...
import { CardCvvValidator } from './card-cvv.validator';

@Component({
    selector: 'asw-card-cvv',
    template: `
      <div class="asw-card-cvv-container" [ngClass]="styleClass">
        <input
            [ngClass]="{'asw-card-cvv-input': !defaultStyles}"
            type="text"
...
export class AswCardCvv implements OnInit, OnDestroy, DoCheck, ControlValueAccessor, MatFormFieldControl<AswCardCvv> {
    ...
    @HostBinding() id = `ngx-cc${AswCardCvv.nextId}`;
